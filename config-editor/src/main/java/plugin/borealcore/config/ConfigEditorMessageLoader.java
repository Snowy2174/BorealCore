...
public class ConfigEditorMessageLoader {
    ...
    public static void load() {
        ...
        messageDefaults.put("config-editor-saving-error", "DatabaseError saving config: {error}");
        ...
        messageDefaults.put("config-editor-reading-error", "DatabaseError reading folder: {error}");
        ...
        ConfigEditorMessage.configEditorSavingError = messages.getString("messages.config-editor-saving-error", "DatabaseError saving config: {error}");
        ...
        ConfigEditorMessage.configEditorReadingError = messages.getString("messages.config-editor-reading-error", "DatabaseError reading folder: {error}");
