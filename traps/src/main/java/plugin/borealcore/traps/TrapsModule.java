...
public class TrapsModule extends Function implements BorealModule {
    ...
    @Override
    public void load() {
        AdventureUtil.consoleMessage("Loading TrapsModule...");
        TRAPS = new HashMap<>();
        // @TODO: loadItems();
        ...
        AdventureUtil.consoleMessage("TrapsModule loaded successfully");
    }
