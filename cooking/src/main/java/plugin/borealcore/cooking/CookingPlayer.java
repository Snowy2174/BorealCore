...
public class CookingPlayer extends BukkitRunnable {
    ...
    public CookingPlayer(long deadline, Player player, Layout layout, Difficulty difficulty, CookingModule cookingModule) {
    ...
    public void run() {
        if (System.currentTimeMillis() > deadline) {
            ...
            cookingModule.removeCookingPlayer(player);
            cancel();
            return;
        }
