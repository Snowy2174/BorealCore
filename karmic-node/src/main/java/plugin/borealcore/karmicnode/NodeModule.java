...
public class NodeModule implements BorealModule {
    ...
    public void onModuleEnable() throws Exception {
        ...
        context.getPlaceholderManager().registerExpansion(nodePlaceholders);
    }

    @Override
    public void onModuleDisable() throws Exception {
        if (this.nodePlaceholders != null) context.getPlaceholderManager().unregisterExpansion(this.nodePlaceholders);
    }

    @Override
    public void onModuleInitialize(ModuleContext context) throws Exception {
        this.context = context;
        context.getPlugin().getCommand("kn").setExecutor(new NodeCommand());
    }
